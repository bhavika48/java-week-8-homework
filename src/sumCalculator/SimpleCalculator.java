...
/*
18. Sum Calculator
Write a class with the name mathsCalculator.SimpleCalculator. The class needs two fields (instance variables) with
...
mathsCalculator.SimpleCalculator calculator = new mathsCalculator.SimpleCalculator();
...
public class SimpleCalculator {
    ...
    // method without params with return type
    public double getAdditionResult(){
        double additionresult = 0;
        additionresult =this.firstNumber + this.secondNumber;
        return additionresult;

    }
    public double getSubtractionResult(){
        double subtractionResult =0;
        subtractionResult = this.secondNumber - this.firstNumber;
